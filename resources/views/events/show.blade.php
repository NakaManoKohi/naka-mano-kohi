    ...
    <main class="col-12 pe-2">
      <section class="col-12 bg-primary-grey card border-0">
        <div class="card-header bg-brown text-white">
          <h3><a href="/" class="text-decoration-none text-white">Home</a> / <a href="/event" class="text-decoration-none text-white">Blog</a> / <a href="/blog/{{ $event->slug }}" class="text-decoration-none text-white">{{ $event->title }}</a></h3>
        </div>
        <div class="card-body">
