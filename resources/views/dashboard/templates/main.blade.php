...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <form action="/dashboard/search" class="w-100">
    <input class="form-control form-control-dark w-100 rounded-0 border-0" name="search" type="text" placeholder="Search" aria-label="Search">
  </form>
