            ...
            @foreach ($blogs as $blog)
              <div class="card card-body border border-5 border-yellow blog-card-highlight mb-3">
                ...
                @if(auth()->user()->username == $user->username)
                    <a class="nav-link text-dark text-decoration-none dropdown-toggle no-arrow me-3 fs-4 px-3 rounded bg-white px-3 rounded" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="position:absolute; z-index: 9999; right: 10px;"><i class="fa fa-solid fa-ellipsis-vertical"></i></a>
